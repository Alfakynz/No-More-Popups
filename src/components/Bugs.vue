...
<template>
  <main>
    ...
    <section class="wiki-content">
      ...
      <p>
        If you encounter a bug in No More Pop-ups or have an idea to suggest, please help me by
        letting me know! You can use either of the following methods:
      </p>
      <ol>
        <li>
          <strong>
            Open an issue on
            <a
              href="https://github.com/Alfakynz/no-more-popups/issues"
              target="_blank"
              rel="noopener"
              >GitHub</a
            >:
      ...
      <p>Thank you for helping me improve No More Pop-ups!</p>
    </section>
  </main>
</template>
